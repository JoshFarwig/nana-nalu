...
from schemas.auth_schema import UserEmailLogin, UserUsernameLogin, TokenResponse
...
class AuthService:
    ...
    async def register(self, user_data: UserCreate):
        ...
        # TODO: in the future, add tier logic here, but for now, all users
        # create will be under the free tier
        ...
        ttl_seconds = self.settings.api.refresh_token_expire_days * 24 * 60 * 60
        ...
        try:
            match login_data:
                ...
                case UserUsernameLogin(username=user_username, password=user_password):
                    user = await self.user_repo.get_by_username(user_username)
